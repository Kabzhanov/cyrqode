...
Универсальный идентификатор сущностей и доказуемый журнал событий и связей.
...
Любая система учёта отвечает на вопрос «что записано». Circle Mark отвечает на
другой: **что произошло, в какой связи с остальным, по чьим полномочиям и можно
ли это доказать через год.**

Пример. Цех выпустил партию продукции. В учётной системе появится строка. Circle
Mark хранит другое: партия произведена из таких-то входных партий, на таком-то
...
знает только сам владелец данных, в своей системе. Circle Mark при этом способен
...
разные вещи**. NFC-карта, печатная марка, метка на оборудовании — это носители.
...
```bash
git clone <репозиторий> && cd circlemark
...
Название Circle Mark — товарный знак BizDNAi, см. [TRADEMARK.md](TRADEMARK.md).
